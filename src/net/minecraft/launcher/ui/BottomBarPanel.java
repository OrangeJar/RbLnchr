...
import net.minecraft.launcher.ui.bottombar.ConfigButtonPanel;
...
public class BottomBarPanel extends JPanel {
   ...
   private final ConfigButtonPanel configButtonPanel;
   ...
   public BottomBarPanel(Launcher launcher) {
      ...
      this.configButtonPanel = new ConfigButtonPanel(launcher);
   ...
   protected void createInterface() {
      ...
      this.add(this.configButtonPanel);
   ...
   public PlayButtonPanel getPlayButtonPanel() {
    ...
    public ConfigButtonPanel getConfigButtonPanel() {
        return this.configButtonPanel;
    }
}
